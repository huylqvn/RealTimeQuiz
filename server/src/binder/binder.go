...
func (b *DefaultBinder) BindPathParams(r *http.Request, i interface{}) error {
	...
	names := ctx.URLParams.Keys
	values := ctx.URLParams.Values
...
func (b *DefaultBinder) BindQueryParams(r *http.Request, i interface{}) error {
	if err := b.bindData(i, r.URL.Query(), "query"); err != nil {
		return err
	}
	return nil
}
...
func (b *DefaultBinder) BindBody(r *http.Request, i interface{}) (err error) {
	...
	case strings.HasPrefix(ctype, MIMEApplicationForm), strings.HasPrefix(ctype, MIMEMultipartForm):
		if strings.HasPrefix(r.Header.Get(HeaderContentType), MIMEMultipartForm) {
			...
			if err := bindFile(i, r, r.MultipartForm.File); err != nil {
				return err
			}
		} else {
			err := r.ParseForm()
		...
		if err = b.bindData(i, r.Form, "form"); err != nil {
			return err
		}
	default:
		return fmt.Errorf("Unsupported Content-Type: %v", ctype)
	}
	return nil
}
...
func (b *DefaultBinder) BindHeaders(r *http.Request, i interface{}) error {
	if err := b.bindData(i, r.Header, "header"); err != nil {
		return err
	}
	return nil
}
...
func (b *DefaultBinder) Bind(i interface{}, r *http.Request) (err error) {
