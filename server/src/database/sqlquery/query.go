...
func OrderAscEx(colName string) ClauseOrderBy {
...
func OrderDescClause(colName string) ClauseOrderBy {
	return ClauseOrderBy{
		OrderBy: clause.OrderBy{
			Columns: []clause.OrderByColumn{
				{
...
func DbOrderEx(db *gorm.DB, tableName, colName string, desc bool) *gorm.DB {
	...
	return db.Clauses(ClauseOrderBy{
		OrderBy: clause.OrderBy{
...
func OrderExpression(expr clause.Expression, desc bool) ClauseOrderBy {
	return ClauseOrderBy{
		OrderBy: clause.OrderBy{
			Expression: expr,
		},
...
func OrderAscPositiveFirst(colName string) ClauseOrderBy {
	return ClauseOrderBy{
		OrderBy: clause.OrderBy{
